...
import { TrendingUp, TrendingDown, Coins, BookOpen, Wallet, CalendarDays, Zap, AlertTriangle, Receipt, Boxes, Box, ArrowRight } from 'lucide-react';
import { cn } from '../lib/utils';

export function Dashboard() {
  const { transacoes, fiados, produtos, settings, setNav } = useStore();
  ...
  return (
    <div className="p-6 md:p-8 max-w-7xl mx-auto w-full space-y-8 animate-fade pb-24">
...
function TransactionItem({ tx }: { tx: any }) {
  ...
  else if (isPagamento) { color = "text-secondary"; bgIcon = "bg-secondary-light text-secondary"; IconComponent = Wallet; }
